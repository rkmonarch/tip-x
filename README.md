...
Every user must have Metamask wallet to interact with this product. Checkout how to create Metamask wallet from [here](https://metamask.io). 
...
```sh
git clone https://github.com/rkmonarch/tip-land.git 
cd tip-land
```
